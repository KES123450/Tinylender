...
int main()
{
    ...
    Button *fileBtn = new Button(glm::vec3(-0.957418496340652f, 0.9390243902439024f, 0.0f), 0.05056553559547571f, 0.09268292682926829f, "resource/state/fileIcon.png", eImageType::PNG);
    ...
    Button *dotBtn = new Button(glm::vec3(-0.8775781769793746f, 0.9390243902439024f, 0.0f), 0.05056553559547571f, 0.09268292682926829f, "resource/state/dotIcon.png", eImageType::PNG);
    ...
    Button *squareBtn = new Button(glm::vec3(-0.7165668662674651f, 0.9390243902439024f, 0.0f), 0.05056553559547571f, 0.09268292682926829f, "resource/state/extrudeIcon.png", eImageType::PNG);
    ...
    Button *selectBtn = new Button(glm::vec3(-0.7165668662674651f, 0.9390243902439024f, 0.0f), 0.05056553559547571f, 0.09268292682926829f, "resource/state/selectIcon.png", eImageType::PNG);
