...
class TextBox : public Widget, public IPressedDown, public IPressed, public IPressedUp, public IKeyDown
{
public:
    TextBox(glm::vec3 textBoxPos, float sizeX, float sizeY, std::string text, float textSize, glm::vec3 textColor, bool stringFlag, float dragOffset);
